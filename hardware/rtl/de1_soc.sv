...
module de1_soc(input CLOCK_50,
	...
	engine #(
		...
		.SEARCH_THREAD_COUNT(ENGINE_SEARCH_THREAD_COUNT),
		...
		.ASPIRATION_DELTA_MULTIPLIER_Q3(ENGINE_ASPIRATION_DELTA_MULTIPLIER_Q3),
		.LMR_MINIMUM_DEPTH(ENGINE_LMR_MINIMUM_DEPTH),
		.LMR_MINIMUM_MOVE_NUMBER(ENGINE_LMR_MINIMUM_MOVE_NUMBER),
		.NULL_MINIMUM_DEPTH(ENGINE_NULL_MINIMUM_DEPTH),
		.NULL_DEEP_DEPTH_THRESHOLD(ENGINE_NULL_DEEP_DEPTH_THRESHOLD),
		.NULL_SHALLOW_REDUCTION(ENGINE_NULL_SHALLOW_REDUCTION),
		.NULL_DEEP_REDUCTION(ENGINE_NULL_DEEP_REDUCTION),
		.RFP_BASE_MARGIN(ENGINE_RFP_BASE_MARGIN),
		.RFP_MARGIN_PER_DEPTH(ENGINE_RFP_MARGIN_PER_DEPTH),
		.RFP_MAXIMUM_DEPTH(ENGINE_RFP_MAXIMUM_DEPTH),
		.FUTILITY_BASE_MARGIN(ENGINE_FUTILITY_BASE_MARGIN),
		.FUTILITY_MARGIN_PER_DEPTH(ENGINE_FUTILITY_MARGIN_PER_DEPTH),
		.FUTILITY_MAXIMUM_DEPTH(ENGINE_FUTILITY_MAXIMUM_DEPTH),
		.QDELTA_MARGIN(ENGINE_QDELTA_MARGIN),
		.MOVES_TO_GO_BUFFER(ENGINE_MOVES_TO_GO_BUFFER),
		.DEFAULT_MOVES_DIVISOR(ENGINE_DEFAULT_MOVES_DIVISOR),
		.INCREMENT_NUMERATOR(ENGINE_INCREMENT_NUMERATOR),
		.INCREMENT_DENOMINATOR(ENGINE_INCREMENT_DENOMINATOR),
		.HARD_BASE_MULTIPLIER(ENGINE_HARD_BASE_MULTIPLIER),
		.HARD_TIME_NUMERATOR(ENGINE_HARD_TIME_NUMERATOR),
		.HARD_TIME_DENOMINATOR(ENGINE_HARD_TIME_DENOMINATOR),
		.SOFT_FACTOR_DEFAULT(ENGINE_SOFT_FACTOR_DEFAULT),
		.SOFT_FACTOR_MINIMUM(ENGINE_SOFT_FACTOR_MINIMUM),
		.SOFT_FACTOR_MAXIMUM(ENGINE_SOFT_FACTOR_MAXIMUM),
		.STABLE_DEPTH_THRESHOLD(ENGINE_STABLE_DEPTH_THRESHOLD),
		.SCORE_DROP_THRESHOLD(ENGINE_SCORE_DROP_THRESHOLD),
		.NEXT_DEPTH_NUMERATOR(ENGINE_NEXT_DEPTH_NUMERATOR),
		.NEXT_DEPTH_DENOMINATOR(ENGINE_NEXT_DEPTH_DENOMINATOR),
		.SINGLE_LEGAL_MOVE_MS(ENGINE_SINGLE_LEGAL_MOVE_MS),
		.MOVE_MEMORY_ENTRIES(ENGINE_MOVE_MEMORY_ENTRIES),
		.MOVE_BUCKET_0_RATIO(ENGINE_MOVE_BUCKET_0_RATIO),
		.MOVE_BUCKET_1_RATIO(ENGINE_MOVE_BUCKET_1_RATIO),
		.MOVE_BUCKET_2_RATIO(ENGINE_MOVE_BUCKET_2_RATIO),
		.MOVE_BUCKET_3_RATIO(ENGINE_MOVE_BUCKET_3_RATIO),
		.MOVE_BUCKET_4_RATIO(ENGINE_MOVE_BUCKET_4_RATIO),
		.MOVE_BUCKET_5_RATIO(ENGINE_MOVE_BUCKET_5_RATIO),
		.MOVE_BUCKET_6_RATIO(ENGINE_MOVE_BUCKET_6_RATIO),
		.MOVE_BUCKET_7_RATIO(ENGINE_MOVE_BUCKET_7_RATIO),
		.HISTORY_ENTRY_COUNT(ENGINE_HISTORY_ENTRY_COUNT),
		.HISTORY_ENTRY_BITS(ENGINE_HISTORY_ENTRY_BITS),
		.HISTORY_REWARD_PER_DEPTH(ENGINE_HISTORY_REWARD_PER_DEPTH),
		.HISTORY_MAXIMUM_REWARD(ENGINE_HISTORY_MAXIMUM_REWARD),
		.HISTORY_MALUS_DIVISOR(ENGINE_HISTORY_MALUS_DIVISOR),
		.QUIET_THRESHOLD_1(ENGINE_QUIET_THRESHOLD_1),
		.QUIET_THRESHOLD_2(ENGINE_QUIET_THRESHOLD_2),
		.QUIET_THRESHOLD_3(ENGINE_QUIET_THRESHOLD_3),
		.CASTLING_HISTORY_BONUS(ENGINE_CASTLING_HISTORY_BONUS),
