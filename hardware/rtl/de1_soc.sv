...
module de1_soc(input CLOCK_50,
	...
	engine #(
		...
		.MOVE_OVERHEAD_MS(ENGINE_MOVE_OVERHEAD_MS),
		.MINIMUM_SEARCH_MS(ENGINE_MINIMUM_SEARCH_MS),
		.INCREMENT_NUMERATOR(ENGINE_INCREMENT_NUMERATOR),
		.INCREMENT_DENOMINATOR(ENGINE_INCREMENT_DENOMINATOR),
		.REMAINING_TIME_NUMERATOR(ENGINE_REMAINING_TIME_NUMERATOR),
		.REMAINING_TIME_DENOMINATOR(ENGINE_REMAINING_TIME_DENOMINATOR),
