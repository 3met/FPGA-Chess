...
module tb_engine_profile #(
    ...
    engine #(
        ...
        .MOVES_TO_GO_BUFFER(MOVES_TO_GO_BUFFER), .DEFAULT_MOVES_DIVISOR(DEFAULT_MOVES_DIVISOR),
        ...
        .HARD_TIME_NUMERATOR(HARD_TIME_NUMERATOR), .HARD_TIME_DENOMINATOR(HARD_TIME_DENOMINATOR),
        .SOFT_FACTOR_DEFAULT(SOFT_FACTOR_DEFAULT), .SOFT_FACTOR_MINIMUM(SOFT_FACTOR_MINIMUM),
        .SOFT_FACTOR_MAXIMUM(SOFT_FACTOR_MAXIMUM), .STABLE_DEPTH_THRESHOLD(STABLE_DEPTH_THRESHOLD),
    ...
    always @(posedge engine_clk) begin
        ...
        if (profile_active) begin
            ...
            if (dut.controller.profile_futility_prune_event)
                futility_pruned_moves <= futility_pruned_moves + 1;
    ...
    task automatic write_metrics();
        ...
        emit("algorithm.futility_pruned_moves", futility_pruned_moves);
            ...
            begin
                ...
                case (search_kind)
                    ...
                    default: begin
                        ...
                        for (int idx = 0; idx < 3; idx++) send_byte(8'd0);
                    end
                endcase
            end
        join
