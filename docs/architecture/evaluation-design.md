...
The board update pipeline updates material and PST state together with every board operation.
...
The output orders the side-to-move perspective before the opposing perspective and produces a side-to-move-relative correction. Model widths, packing, update behavior, and generated files are defined in [nnue-evaluator.md](../modules/nnue-evaluator.md).
