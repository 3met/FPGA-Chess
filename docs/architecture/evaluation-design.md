...
The static evaluator operates from board-state inputs plus `base_eval`. Its interface is a board-state pipeline interface, and it does not own the canonical board state. The internal evaluation structure is not part of the architectural contract.
