...
`EvalScore` is a signed 16-bit value. Raw evaluation and incremental PST/material state are White-relative: positive scores are good for White and negative scores are good for Black. Search converts raw evaluation into side-to-move point-of-view scores at search boundaries.
