...
| 10 | Check strict legality on the selected proposal using a virtual-board king attack test, update the consumed mask, and register the result before the external output boundary. |
