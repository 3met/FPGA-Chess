...
The controller defaults are `SEARCH_THREAD_COUNT = THREAD_COUNT`, `SEARCH_STACK_DEPTH = MAX_PLY_COUNT`, `ACTIVE_REPETITION_DEPTH = 100`, and `ENABLE_SEARCH_STATS = 0`. Perft, Zobrist/repetition handling, TT traffic, and incremental PST evaluation are always present.
