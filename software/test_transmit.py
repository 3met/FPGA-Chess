...
from software.transmit import SerialDependencyError, SerialPortInfo, get_serial_port
...
class SerialPortDetectionTests(unittest.TestCase):
    ...
    def test_single_port_is_selected(self):
        ...
        with mock.patch.dict(os.environ, {}, clear=True), mock.patch("software.transmit.list_serial_ports", return_value=ports):
